cc.Class({
    ...
    shoot:function(mjId){
        ...
        cc.vv.net.sendRequest('connector.GameService.chupai',{mjId:mjId});
    },
    ...
    onOptionClicked:function(event){
        ...
        if(event.target.name == "btnPeng"){
            cc.vv.net.sendRequest("connector.GameService.peng",{},function () {
                console("发送请求peng");
            });
        }
        else if(event.target.name == "btnGang"){
            cc.vv.net.sendRequest("connector.GameService.gang",event.target.pai,function () {
                console("发送请求gang");
            });
        }
        else if(event.target.name == "btnHu"){
            cc.vv.net.sendRequest("connector.GameService.hu",{},function () {
                console("发送请求hu");
            });
        }
        else if(event.target.name == "btnGuo"){
            cc.vv.net.sendRequest("connector.GameService.guo",{},function () {
                console("发送请求guo");
            });
        }
    },
