cc.Class({
    ...
    initHandlers:function(){
        ...
        cc.vv.net.addHandler("new_user_comes_push",function(data){
            console.log("到达new_user_comes_push");
            console.log(data);
            data = data.msg;
        ...
        cc.vv.net.addHandler("game_action_push",function(data){
            console.log("到达game_action_push");
            console.log(data);
            self.curaction = data;
        ...
        cc.vv.net.addHandler("game_chupai_push",function(data){
            console.log('到达game_chupai_push');
            data = data.msg;
            var turnUserID = data;
    ...
    connectGameServer:function(data){
        ...
        cc.vv.net.sendRequest("connector.GameService.login",sd,function (ret) {
